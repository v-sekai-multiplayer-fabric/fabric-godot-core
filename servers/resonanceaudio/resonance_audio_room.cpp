...
void ResonanceAudioRoom::set_room_effects_enabled(bool p_enabled) { room_effects_enabled = p_enabled; }
bool ResonanceAudioRoom::get_room_effects_enabled() const { return room_effects_enabled; }

void ResonanceAudioRoom::set_reflection_gain(float p_gain) { reflection_gain = p_gain; }
float ResonanceAudioRoom::get_reflection_gain() const { return reflection_gain; }

void ResonanceAudioRoom::set_reverb_gain(float p_gain) { reverb_gain = p_gain; }
float ResonanceAudioRoom::get_reverb_gain() const { return reverb_gain; }

void ResonanceAudioRoom::set_reverb_brightness(float p_brightness) { reverb_brightness = p_brightness; }
float ResonanceAudioRoom::get_reverb_brightness() const { return reverb_brightness; }

void ResonanceAudioRoom::set_reverb_time_scale(float p_scale) { reverb_time_scale = p_scale; }
float ResonanceAudioRoom::get_reverb_time_scale() const { return reverb_time_scale; }

void ResonanceAudioRoom::set_wall_material(int p_material) { wall_material = p_material; }
int ResonanceAudioRoom::get_wall_material() const { return wall_material; }
