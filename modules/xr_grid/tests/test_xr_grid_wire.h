...
/*  test_xr_grid_wire.h                                                    */
/**************************************************************************/
/* Wire-format regression tests for xr-grid native ports:                  */
/*  - XRGridEntityPacket   (100-byte fabric envelope)                      */
/*  - XRGridSwingTwistCodec (quaternion ↔ swing-twist Vector3 ↔ i16x3)    */
/*  - XRGridBoolTimer       (deadline-true wall-clock semantics)           */
/*                                                                         */
/* These lock the bits going over the WebTransport reliable channel and    */
/* across the entity packet round-trip — peers running this engine all     */
/* parse + re-encode each packet identically. Add cases here whenever the  */
/* wire format extends.                                                    */
