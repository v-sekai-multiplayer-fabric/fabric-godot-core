...
void XRGridGPUTrail3D::set_vertical_texture(bool p_v) { vertical_texture = p_v; _refresh_flags(); }
void XRGridGPUTrail3D::set_use_red_as_alpha(bool p_v) { use_red_as_alpha = p_v; _refresh_flags(); }
void XRGridGPUTrail3D::set_billboard(bool p_v) { billboard = p_v; _refresh_flags(); }
void XRGridGPUTrail3D::set_dewiggle(bool p_v) { dewiggle = p_v; _refresh_flags(); }
void XRGridGPUTrail3D::set_clip_overlaps(bool p_v) { clip_overlaps = p_v; _refresh_flags(); }
void XRGridGPUTrail3D::set_snap_to_transform(bool p_v) { snap_to_transform = p_v; _refresh_flags(); }
