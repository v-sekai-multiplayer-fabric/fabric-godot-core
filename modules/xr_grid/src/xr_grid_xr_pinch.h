...
/*  xr_grid_xr_pinch.h                                                     */
/**************************************************************************/
/* Native port of xr-grid/addons/procedural_3d_grid/core/xr_pinch.gd.      */
/* Two-handed world-grab / pinch-zoom / orbit interaction for VR canvas    */
/* manipulation. Reads `grip` from both hands, integrates a target         */
/* transform per frame, and damps with linear + angular velocity.          */
