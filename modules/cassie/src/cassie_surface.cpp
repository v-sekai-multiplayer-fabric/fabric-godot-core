...
void CassieSurface::set_auto_beautify(bool p_enable) { auto_beautify = p_enable; }
bool CassieSurface::get_auto_beautify() const { return auto_beautify; }

void CassieSurface::set_auto_resample(bool p_enable) { auto_resample = p_enable; }
bool CassieSurface::get_auto_resample() const { return auto_resample; }

void CassieSurface::set_use_intrinsic_remeshing(bool p_enable) { use_intrinsic_remeshing = p_enable; }
bool CassieSurface::get_use_intrinsic_remeshing() const { return use_intrinsic_remeshing; }

void CassieSurface::set_target_boundary_points(int p_count) { target_boundary_points = MAX(3, p_count); }
int CassieSurface::get_target_boundary_points() const { return target_boundary_points; }

void CassieSurface::set_beautify_lambda(float p_lambda) { beautify_lambda = CLAMP(p_lambda, 0.0f, 1.0f); }
float CassieSurface::get_beautify_lambda() const { return beautify_lambda; }

void CassieSurface::set_beautify_mu(float p_mu) { beautify_mu = CLAMP(p_mu, -1.0f, 0.0f); }
float CassieSurface::get_beautify_mu() const { return beautify_mu; }

void CassieSurface::set_beautify_iterations(int p_iterations) { beautify_iterations = MAX(0, p_iterations); }
int CassieSurface::get_beautify_iterations() const { return beautify_iterations; }

void CassieSurface::set_max_flip_iterations(int p_iterations) { max_flip_iterations = MAX(0, p_iterations); }
int CassieSurface::get_max_flip_iterations() const { return max_flip_iterations; }

void CassieSurface::set_smooth_iterations(int p_iterations) { smooth_iterations = MAX(0, p_iterations); }
int CassieSurface::get_smooth_iterations() const { return smooth_iterations; }

void CassieSurface::set_target_edge_length(float p_length) { target_edge_length = p_length; }
float CassieSurface::get_target_edge_length() const { return target_edge_length; }
