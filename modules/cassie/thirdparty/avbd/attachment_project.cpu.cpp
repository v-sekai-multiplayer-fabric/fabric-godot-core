...
namespace cassie_slang_attachment_project {


#line 12 "../thirdparty/avbd/attachment_project.cpu.slang"
struct GlobalParams_0
{
    RWStructuredBuffer<Vector<float, 3> > projected_0;
    StructuredBuffer<Vector<float, 3> > fixedPos_0;
    StructuredBuffer<float> sqrtWeight_0;
};
...
#line 9
    ...
    float sw_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->sqrtWeight_0.Load(c_0);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->projected_0)[c_0]) = Vector<float, 3> (sw_0 * fp_0.x, sw_0 * fp_0.y, sw_0 * fp_0.z);
    return;
}
