...
namespace cassie_slang_cg_pcg3_dot_p_ap {
...
#line 117
void _dot_p_ap(void* _S1, void* entryPointParams_0, void* globalParams_1)
{
...
#line 121
        Vector<float, 3>  * _S2 = (&((&kernelContext_0)->globalParams_0->p_0)[i_0]);
        Vector<float, 3>  * _S3 = (&((&kernelContext_0)->globalParams_0->Ap_0)[i_0]);
        float px_hi_0;
        float px_lo_0;
...
#line 144
    *(&((&kernelContext_0)->globalParams_0->scalars_0)[2U]) = acc_hi_0;
    *(&((&kernelContext_0)->globalParams_0->scalars_0)[3U]) = acc_lo_0;
    return;
}

// [numthreads(1, 1, 1)]
SLANG_PRELUDE_EXPORT
void dot_p_ap_Thread(ComputeThreadVaryingInput* varyingInput, void* entryPointParams, void* globalParams)
{
    _dot_p_ap(varyingInput, entryPointParams, globalParams);
}
// [numthreads(1, 1, 1)]
SLANG_PRELUDE_EXPORT
void dot_p_ap_Group(ComputeVaryingInput* varyingInput, void* entryPointParams, void* globalParams)
{
    ComputeThreadVaryingInput threadInput = {};
    threadInput.groupID = varyingInput->startGroupID;
    _dot_p_ap(&threadInput, entryPointParams, globalParams);
}
// [numthreads(1, 1, 1)]
SLANG_PRELUDE_EXPORT
void dot_p_ap(ComputeVaryingInput* varyingInput, void* entryPointParams, void* globalParams)
{
    ...
    for (uint32_t z = vi.startGroupID.z; z < vi.endGroupID.z; ++z)
    {
        ...
        for (uint32_t y = vi.startGroupID.y; y < vi.endGroupID.y; ++y)
        {
            ...
            for (uint32_t x = vi.startGroupID.x; x < vi.endGroupID.x; ++x)
            {
                ...
                dot_p_ap_Group(&groupVaryingInput, entryPointParams, globalParams);
            }
        }
    }
}
