...
struct grid_cell {
    std::int64_t x, y, z;
    bool operator==(const grid_cell &) const = default;
};
...
std::vector<grid_cell> voxelize_like_open3d(
    std::span<const vec3> vertices, std::span<const triangle> faces, double voxel_size) {
